...
public class ViewOverdueItemsDialog extends JDialog {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ViewOverdueItemsDialog frame = new ViewOverdueItemsDialog(null);
	 ...
	 * Create the frame.
	 */
	public ViewOverdueItemsDialog(JFrame parent) {
		setAlwaysOnTop(true);
		setModal(true);
		setModalityType(ModalityType.APPLICATION_MODAL);
		setType(Type.UTILITY);
		setTitle("View Overdue Items");
		...
		List<MonitoredItem> items = PropertyMonitor.instance().overdueItemsBefore(LocalDate.now());
