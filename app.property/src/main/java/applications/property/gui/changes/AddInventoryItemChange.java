...
public class AddInventoryItemChange extends AbstractChange {
	private static final String CLASS_NAME = AddInventoryItemChange.class.getName();
	private static final Logger LOGGER = ApplicationConfiguration.logger();

	private InventoryItem item;

	public AddInventoryItemChange(InventoryItem item) {
		this.item = item;
	}
