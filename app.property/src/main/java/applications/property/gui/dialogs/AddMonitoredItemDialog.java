...
public class AddMonitoredItemDialog extends JDialog {
	public static final int OK_PRESSED = 1;
	public static final int CANCEL_PRESSED = 0;
	private static final long serialVersionUID = 1L;

	private static final String CLASS_NAME = AddMonitoredItemDialog.class.getName();
	...
	public static void main(String[] args) {
		try {
			AddMonitoredItemDialog dialog = new AddMonitoredItemDialog(null);
	 ...
	 * Create the dialog.
	 */
	public AddMonitoredItemDialog(JFrame parent) {
		super();
		...
		{
			JLabel lblNewLabel = new JLabel("Enter the details below to add an item. ");
