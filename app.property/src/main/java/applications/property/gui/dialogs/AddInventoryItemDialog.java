...
public class AddInventoryItemDialog extends JDialog {
	...
	private static final String CLASS_NAME = AddInventoryItemDialog.class.getName();
	...
	public static void main(String[] args) {
		try {
			AddInventoryItemDialog dialog = new AddInventoryItemDialog(null);
	 ...
	 * Create the dialog.
	 */
	public AddInventoryItemDialog(JFrame parent) {
		super();
